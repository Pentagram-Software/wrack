...
- **Reused, unchanged**: `edge/video-streamer/`'s camera capture path, the unified ingress Cloud Function, `bigquery-client.js`, and the `wrack_telemetry.events` table schema — none of these require code changes.
