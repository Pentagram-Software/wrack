...
Each evaluated frame SHALL produce a detection result consisting of a presence/absence outcome, a confidence score, and (when a cat is present) a crop or bounding box suitable for downstream identification.
